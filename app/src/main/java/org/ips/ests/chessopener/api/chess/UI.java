...
public class UI extends GameControl
{
	...
	{
		//Log.i("requestMove debug", m_game.getBoard().getPGNMoves(new BoardConstants()));
		if(_jni.isEnded() != 0)
			return false;
	...
	public void updateState()
	{
		...
		//co.pl(BoardConstants.bitbToString(m_game.getBoard().bitbAttacked()));
	}
	
	public int chessStateToR(int s){
		switch(s)
		{
		case BoardConstants.MATE: return R.string.state_mate;
		case BoardConstants.DRAW_MATERIAL: return R.string.state_draw_material; 
		case BoardConstants.CHECK: return R.string.state_check; 
		case BoardConstants.STALEMATE: return R.string.state_draw_stalemate; 
		case BoardConstants.DRAW_50: return R.string.state_draw_50; 
		case BoardConstants.DRAW_REPEAT: return R.string.state_draw_repeat;
