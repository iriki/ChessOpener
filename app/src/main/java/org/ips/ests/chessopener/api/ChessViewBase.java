...
public class ChessViewBase{
	...
	public void init(OnClickListener ocl){
		...
		try{
			...
			// pawn
			ChessImageView._arrPieceBitmaps[BoardConstants.BLACK][BoardConstants.PAWN] = BitmapFactory.decodeStream(am.open(sFolder + "pb.png"));
			ChessImageView._arrPieceBitmaps[BoardConstants.WHITE][BoardConstants.PAWN] = BitmapFactory.decodeStream(am.open(sFolder + "pw.png"));
		
			// kNight
			ChessImageView._arrPieceBitmaps[BoardConstants.BLACK][BoardConstants.KNIGHT] = BitmapFactory.decodeStream(am.open(sFolder + "nb.png"));
			ChessImageView._arrPieceBitmaps[BoardConstants.WHITE][BoardConstants.KNIGHT] = BitmapFactory.decodeStream(am.open(sFolder + "nw.png"));
			
			// bishop
			ChessImageView._arrPieceBitmaps[BoardConstants.BLACK][BoardConstants.BISHOP] = BitmapFactory.decodeStream(am.open(sFolder + "bb.png"));
			ChessImageView._arrPieceBitmaps[BoardConstants.WHITE][BoardConstants.BISHOP] = BitmapFactory.decodeStream(am.open(sFolder + "bw.png"));
			
			// rook		
			ChessImageView._arrPieceBitmaps[BoardConstants.BLACK][BoardConstants.ROOK] = BitmapFactory.decodeStream(am.open(sFolder + "rb.png"));
			ChessImageView._arrPieceBitmaps[BoardConstants.WHITE][BoardConstants.ROOK] = BitmapFactory.decodeStream(am.open(sFolder + "rw.png"));
			
			// queen
			ChessImageView._arrPieceBitmaps[BoardConstants.BLACK][BoardConstants.QUEEN] = BitmapFactory.decodeStream(am.open(sFolder + "qb.png"));
			ChessImageView._arrPieceBitmaps[BoardConstants.WHITE][BoardConstants.QUEEN] = BitmapFactory.decodeStream(am.open(sFolder + "qw.png"));
			
			// king
			ChessImageView._arrPieceBitmaps[BoardConstants.BLACK][BoardConstants.KING] = BitmapFactory.decodeStream(am.open(sFolder + "kb.png"));
			ChessImageView._arrPieceBitmaps[BoardConstants.WHITE][BoardConstants.KING] = BitmapFactory.decodeStream(am.open(sFolder + "kw.png"));
	...
	public void paintBoard(JNI jni, int[] arrSelPositions, ArrayList<Integer> arrPos){
		...
		int i, iResource, iPiece = BoardConstants.PAWN, iColor = BoardConstants.BLACK, iFieldColor;
		...
		/*
		float w = (float)_arrPieceBitmaps[BoardConstants.WHITE][BoardConstants.KING][BoardConstants.WHITE].getWidth() - 2;
		float [] points = {
				0, 0, 0, w, 
				0, w, w, w, 
				w, w, w, 0, 
		...
		*/
		...
		for(i = 0; i < 64; i++)
		{
			...
			iFieldColor = (i&1)==0 ? (((i >> 3) & 1) == 0 ? BoardConstants.WHITE : BoardConstants.BLACK) : (((i >> 3) & 1) == 0 ? BoardConstants.BLACK: BoardConstants.WHITE);
			
			iColor = BoardConstants.BLACK;
			iPiece = jni.pieceAt(iColor, i);
			
			if(iPiece == BoardConstants.FIELD)
			{
				iColor = BoardConstants.WHITE;
				iPiece = jni.pieceAt(iColor, i);
	...
	public void resetImageCache(){
		for(int i = 0; i < 64; i++){
			...
			_arrImgCache[i]._fieldColor = (i&1)==0 ? (((i >> 3) & 1) == 0 ? BoardConstants.WHITE : BoardConstants.BLACK) : (((i >> 3) & 1) == 0 ? BoardConstants.BLACK: BoardConstants.WHITE);
